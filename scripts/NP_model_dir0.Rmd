...
msdata_0_PostMi_severedelay <- msdata_0_cov_PostMi[msdata_0_cov_PostMi$from == 3, ]
...
```{r}
#Pre-Milano.1 & Time Slot:
msdata_0_PreMi.1_peakm<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$time_slot=="Morning-Peak Time", ]
msdata_0_PreMi.1_offpeak<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$time_slot=="Off-Peak Time", ]
msdata_0_PreMi.1_peakp<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$time_slot=="Evening-Peak Time", ]

#Pre-Milano.2 & Time Slot:
msdata_0_PreMi.2_peakm<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$time_slot=="Morning-Peak Time", ]
msdata_0_PreMi.2_offpeak<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$time_slot=="Off-Peak Time", ]
msdata_0_PreMi.2_peakp<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$time_slot=="Evening-Peak Time", ]

#Milano-Città & Time Slot:
msdata_0_Mi_peakm<-msdata_0_cov_Mi[msdata_0_cov_Mi$time_slot=="Morning-Peak Time", ]
msdata_0_Mi_offpeak<-msdata_0_cov_Mi[msdata_0_cov_Mi$time_slot=="Off-Peak Time", ]
msdata_0_Mi_peakp<-msdata_0_cov_Mi[msdata_0_cov_Mi$time_slot=="Evening-Peak Time", ]

#Post-Milano & Time Slot:
msdata_0_PostMi_peakm<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$time_slot=="Morning-Peak Time", ]
msdata_0_PostMi_offpeak<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$time_slot=="Off-Peak Time", ]
msdata_0_PostMi_peakp<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$time_slot=="Evening-Peak Time", ]
```

Check events:
```{r}
#Pre-Milano.1 & Time Slot:
print("Pre-Milano.1 & MorningPeak")
events(msdata_0_PreMi.1_peakm)
print("Pre-Milano.1 & OffPeak")
events(msdata_0_PreMi.1_offpeak)
print("Pre-Milano.1 & EveningPeak")
events(msdata_0_PreMi.1_peakp)

#Pre-Milano.2 & Time Slot:
print("Pre-Milano.2 & MorningPeak")
events(msdata_0_PreMi.2_peakm)
print("Pre-Milano.2 & OffPeak")
events(msdata_0_PreMi.2_offpeak)
print("Pre-Milano.2 & EveningPeak")
events(msdata_0_PreMi.2_peakp)
...
msdata_0_PreMi.1_peakm_ontime <- msdata_0_PreMi.1_peakm[msdata_0_PreMi.1_peakm$from == 1, ]
msdata_0_PreMi.1_offpeak_ontime <- msdata_0_PreMi.1_offpeak[msdata_0_PreMi.1_offpeak$from == 1, ]
msdata_0_PreMi.1_peakp_ontime <- msdata_0_PreMi.1_peakp[msdata_0_PreMi.1_peakp$from == 1, ]

#Survival in SevereDelay for each group:
msdata_0_PreMi.1_peakm_severedelay <- msdata_0_PreMi.1_peakm[msdata_0_PreMi.1_peakm$from == 3, ]
msdata_0_PreMi.1_offpeak_severedelay <- msdata_0_PreMi.1_offpeak[msdata_0_PreMi.1_offpeak$from == 3, ]
msdata_0_PreMi.1_peakp_severedelay <- msdata_0_PreMi.1_peakp[msdata_0_PreMi.1_peakp$from == 3, ]

#KAPLAN-MEIER:
#OnTime
kaplan_meier_0_ontime_PreMi.1_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_peakm_ontime)
kaplan_meier_0_ontime_PreMi.1_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_offpeak_ontime)
kaplan_meier_0_ontime_PreMi.1_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_peakp_ontime)

#SevereDelay
kaplan_meier_0_severedelay_PreMi.1_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_peakm_severedelay)
kaplan_meier_0_severedelay_PreMi.1_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_offpeak_severedelay)
kaplan_meier_0_severedelay_PreMi.1_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.1_peakp_severedelay)



#PRE-MILANO.2 & TIME SLOT
#Survival in OnTime for each group:
msdata_0_PreMi.2_peakm_ontime <- msdata_0_PreMi.2_peakm[msdata_0_PreMi.2_peakm$from == 1, ]
msdata_0_PreMi.2_offpeak_ontime <- msdata_0_PreMi.2_offpeak[msdata_0_PreMi.2_offpeak$from == 1, ]
msdata_0_PreMi.2_peakp_ontime <- msdata_0_PreMi.2_peakp[msdata_0_PreMi.2_peakp$from == 1, ]

#Survival in SevereDelay for each group:
msdata_0_PreMi.2_peakm_severedelay <- msdata_0_PreMi.2_peakm[msdata_0_PreMi.2_peakm$from == 3, ]
msdata_0_PreMi.2_offpeak_severedelay <- msdata_0_PreMi.2_offpeak[msdata_0_PreMi.2_offpeak$from == 3, ]
msdata_0_PreMi.2_peakp_severedelay <- msdata_0_PreMi.2_peakp[msdata_0_PreMi.2_peakp$from == 3, ]


#KAPLAN-MEIER:
#OnTime
kaplan_meier_0_ontime_PreMi.2_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_peakm_ontime)
kaplan_meier_0_ontime_PreMi.2_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_offpeak_ontime)
kaplan_meier_0_ontime_PreMi.2_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_peakp_ontime)

#SevereDelay
kaplan_meier_0_severedelay_PreMi.2_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_peakm_severedelay)
kaplan_meier_0_severedelay_PreMi.2_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_offpeak_severedelay)
kaplan_meier_0_severedelay_PreMi.2_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi.2_peakp_severedelay)



#MILANO & TIME SLOT
#Survival in OnTime for each group:
msdata_0_Mi_peakm_ontime <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 1, ]
msdata_0_Mi_offpeak_ontime <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 1, ]
msdata_0_Mi_peakp_ontime <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 1, ]

#Survival in SevereDelay for each group:
msdata_0_Mi_peakm_severedelay <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 3, ]
msdata_0_Mi_offpeak_severedelay <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 3, ]
msdata_0_Mi_peakp_severedelay <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 3, ]


#KAPLAN-MEIER:
#OnTime
kaplan_meier_0_ontime_Mi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_ontime)
kaplan_meier_0_ontime_Mi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_ontime)
kaplan_meier_0_ontime_Mi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_ontime)

#SevereDelay
kaplan_meier_0_severedelay_Mi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_severedelay)
kaplan_meier_0_severedelay_Mi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_severedelay)
kaplan_meier_0_severedelay_Mi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_severedelay)



#POST-MILANO & TIME SLOT
#Survival in OnTime for each group:
msdata_0_PostMi_peakm_ontime <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 1, ]
msdata_0_PostMi_offpeak_ontime <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 1, ]
msdata_0_PostMi_peakp_ontime <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 1, ]

#Survival in SevereDelay for each group:
msdata_0_PostMi_peakm_severedelay <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 3, ]
msdata_0_PostMi_offpeak_severedealy <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 3, ]
msdata_0_PostMi_peakp_severedelay <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 3, ]


#KAPLAN-MEIER:
#OnTime
kaplan_meier_0_ontime_PostMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_ontime)
kaplan_meier_0_ontime_PostMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_ontime)
kaplan_meier_0_ontime_PostMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_ontime)

#SevereDelay
kaplan_meier_0_severedelay_PostMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_severedelay)
kaplan_meier_0_severedelay_PostMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_severdelay)
kaplan_meier_0_severedelay_PostMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_severdelay)
```

1) PreMilano.1 & Time Slot
```{r}
par(mfrow=c(1,2))

# Survival in OnTime:
plot(kaplan_meier_0_ontime_PreMi.1_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,20))
lines(kaplan_meier_0_ontime_PreMi.1_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ontime_PreMi.1_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)

# Survival in SevereDelay:
plot(kaplan_meier_0_severedelay_PreMi.1_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2, xlim = c(0, 10), conf.int=FALSE)
lines(kaplan_meier_0_severedelay_PreMi.1_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_severedelay_PreMi.1_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```

2) PreMilano.2 & Time Slot
```{r}
par(mfrow=c(1,2))

# Survival in OnTime:
plot(kaplan_meier_0_ontime_PreMi.2_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,20))
lines(kaplan_meier_0_ontime_PreMi.2_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ontime_PreMi.2_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)

# Survival in SevereDelay:
plot(kaplan_meier_0_severedelay_PreMi.2_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2, xlim = c(0, 10), conf.int=FALSE)
lines(kaplan_meier_0_severedelay_PreMi.2_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_severedelay_PreMi.2_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```
...
# Survival in OnTime:
plot(kaplan_meier_0_ontime_Mi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0, 20))
lines(kaplan_meier_0_ontime_Mi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ontime_Mi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)

# Survival in SevereDelay:
plot(kaplan_meier_0_severedelay_Mi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2,, xlim = c(0, 20), conf.int=FALSE)
lines(kaplan_meier_0_severedelay_Mi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_severedelay_Mi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```

2) Post-Milano & Time Slot
```{r}
par(mfrow=c(1,2))

# Survival in OnTime:
plot(kaplan_meier_0_ontime_PostMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,15))
lines(kaplan_meier_0_ontime_PostMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ontime_PostMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)

# Survival in SevereDelay:
plot(kaplan_meier_0_severedelay_PostMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,15))
lines(kaplan_meier_0_severedelay_PostMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_severedelay_PostMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```

Compute Transition Probabilities:
1) Pre-Milano.1 & Time Slot
```{r}
...
pt_list <- list(
  PreMi.1_peakm = pt0_PreMi.1_peakm,
  PreMi.1_offpeak = pt0_PreMi.1_offpeak,
  PreMi.1_peakp = pt0_PreMi.1_peakp
)
state_names <- c("OnTime", "MildDelay", "SevereDelay")
statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
...
pt_list <- list(
  PreMi.2_peakm = pt0_PreMi.2_peakm,
  PreMi.2_offpeak = pt0_PreMi.2_offpeak,
  PreMi.2_peakp = pt0_PreMi.2_peakp
)
state_names <- c("OnTime", "MildDelay", "SevereDelay")
statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
...
pt_list <- list(
  Mi_peakm = pt0_Mi_peakm,
  Mi_offpeak = pt0_Mi_offpeak,
  Mi_peakp = pt0_Mi_peakp
)
state_names <- c("OnTime", "MildDelay", "SevereDelay")
statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
...
pt_list <- list(
  PostMi_peakm = pt0_PostMi_peakm,
  PostMi_offpeak = pt0_PostMi_offpeak,
  PostMi_peakp = pt0_PostMi_peakp
)
state_names <- c("OnTime", "MildDelay", "SevereDelay")
statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
...
AIC and BIC:
```{r}
print("PreMi.1 & Time Slot")
AIC(c0_PreMi.1_peakm)
AIC(c0_PreMi.1_offpeak)
AIC(c0_PreMi.1_peakp)
BIC(c0_PreMi.1_peakm)
BIC(c0_PreMi.1_offpeak)
BIC(c0_PreMi.1_peakp)

print("PreMi.2 & Time Slot")
AIC(c0_PreMi.2_peakm)
AIC(c0_PreMi.2_offpeak)
AIC(c0_PreMi.2_peakp)
BIC(c0_PreMi.2_peakm)
BIC(c0_PreMi.2_offpeak)
BIC(c0_PreMi.2_peakp)
...
print("PostMi & Time Slot")
AIC(c0_PostMi_peakm)
AIC(c0_PostMi_offpeak)
AIC(c0_PostMi_peakp)
BIC(c0_PostMi_peakm)
BIC(c0_PostMi_offpeak)
BIC(c0_PostMi_peakp)
```
