---
title: "Tesi_AbsDelay_S5_v1_dir0"
...
```{r}
data_S5<- data_S5[data_S5$ritardo_ingresso >= -1200 & data_S5$ritardo_ingresso <= 2400, ] #valori scelti tra zscore e osservazioni empiriche dei dati originali
...
Stato 2: RITARDO: 5min < Ritardo <= 10 min
Stato 3: RITARDO GRAVE: Ritardo > 10min
```{r}
...
for (i in 1:nrow(data_S5)) {
  if (is.na(data_S5$status[i])) { # Controlla solo i casi con status NA
    if (data_S5$ora_ingresso[i] != as.POSIXct("1970-01-01 01:00:00")) {
      if (data_S5$ritardo_ingresso[i] > 300) {
        data_S5$status[i] <- "Delay"
      } else {
        data_S5$status[i] <- "OnTime"
      }
    } else if (data_S5$ora_ingresso[i] == as.POSIXct("1970-01-01 01:00:00")) {
      if (data_S5$ritardo_uscita[i] > 300) {
        data_S5$status[i] <- "Delay"
      } else {
        data_S5$status[i] <- "OnTime"
      }
...
unique(data_S5$status) #"OnTime"     "Delay"      "SevereDelay"
...
#View(msdata_0)
dim(msdata_0) #51624    22

#Direzione 1 (Tre-Va):
msdata_1<-S5_msdata[S5_msdata$direzione==1, ]
#View(msdata_1)
dim(msdata_1) #49458    22
...
#Divido il dataset complessivo in 4 parti (a seconda di PreMi, MiCittà e PostMi):
...
msdata_0_cov_Mi<-msdata_0_cov_Mi[msdata_0_cov_Mi$id!=1771, ]
...
### Generale per direzioni diverse ----
...
msf0_peakm <- msfit(object = c0_peakm, vartype = "greenwood", trans = tmat)
summary(msf0_peakm)
...
msf0_peakp <- msfit(object = c0_peakp, vartype = "greenwood", trans = tmat)
summary(msf0_peakp)
...
msf0_offpeak <- msfit(object = c0_offpeak, vartype = "greenwood", trans = tmat)
...
msdata_0_peakm_ritgrave <- msdata_0_peakm[msdata_0_peakm$from == 3, ]
msdata_0_offpeak_ritgrave <- msdata_0_offpeak[msdata_0_offpeak$from == 3, ]
msdata_0_peakp_ritgrave <- msdata_0_peakp[msdata_0_peakp$from == 3, ]
...
pt0_peakm <- probtrans(msf0_peakm, predt = 0, method = "greenwood")

pt0_peakp <- probtrans(msf0_peakp, predt = 0, method = "aalen", variance = TRUE)
pt0_peakp <- probtrans(msf0_peakp, predt = 0, method = "greenwood")

pt0_offpeak <- probtrans(msf0_offpeak, predt = 0, method = "aalen", variance = TRUE)
pt0_offpeak <- probtrans(msf0_offpeak, predt = 0, method = "greenwood")
...
#plot Off peak:
p4<-plot(pt0_offpeak, ord = ord, from=1, xlim=c(0,30), use.ggplot = TRUE)
p4 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
p5<-plot(pt0_offpeak, ord = ord, from=2, xlim=c(0,30), use.ggplot = TRUE)
p5 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p6<-plot(pt0_offpeak, ord = ord, from=3, xlim=c(0,30), use.ggplot = TRUE)
p6 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Peak pome:
p7<-plot(pt0_peakp, ord = ord, from=1, xlim=c(0,30), use.ggplot = TRUE)
p7 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p8<-plot(pt0_peakp, ord = ord, from=2, xlim=c(0,30), use.ggplot = TRUE)
p8 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p9<-plot(pt0_peakp, ord = ord, from=3, xlim=c(0,30), use.ggplot = TRUE)
p9 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
ELOS(pt0_peakp, 130) #metto 130 perchè so che la tratta tot dura circa due ore e dieci
...
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_peakm$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_peakm[msdata_0_peakm$id == id, ]
  }))
...
set.seed(123)  # Per riproducibilità
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_offpeak$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_offpeak[msdata_0_offpeak$id == id, ]
  }))
...
set.seed(123)  # Per riproducibilità
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_peakp$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_peakp[msdata_0_peakp$id == id, ]
  }))
...
#Sopravvivenza in ritardo grave per tutti e tre i gruppi:
msdata_0_PreMi.1_ritgrave <- msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$from == 3, ]
msdata_0_PreMi.2_ritgrave <- msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$from == 3, ]
msdata_0_Mi_ritgrave <- msdata_0_cov_Mi[msdata_0_cov_Mi$from == 3, ]
msdata_0_PostMi_ritgrave <- msdata_0_cov_PostMi[msdata_0_cov_PostMi$from == 3, ]
...
# ord <- c(1,2,3)
#plot: 
p1<-plot(pt0_PreMi.1, ord = ord, from=1, xlim = c(0,30), use.ggplot = TRUE)
p2<-plot(pt0_PreMi.1, ord = ord, from=2, xlim = c(0,30), use.ggplot = TRUE)
p3<-plot(pt0_PreMi.1, ord = ord, from=3, xlim = c(0,30), use.ggplot = TRUE)
p4<-plot(pt0_PreMi.2, ord = ord, from=1, xlim = c(0,30), use.ggplot = TRUE)
p5<-plot(pt0_PreMi.2, ord = ord, from=2, xlim = c(0,30), use.ggplot = TRUE)
p6<-plot(pt0_PreMi.2, ord = ord, from=3, xlim = c(0,30), use.ggplot = TRUE)
p7<-plot(pt0_Mi, ord = ord, from=1, xlim = c(0,30), use.ggplot = TRUE)
p8<-plot(pt0_Mi, ord = ord, from=2, xlim = c(0,30), use.ggplot = TRUE)
p9<-plot(pt0_Mi, ord = ord, from=3, xlim = c(0,30), use.ggplot = TRUE)
p10<-plot(pt0_PostMi, ord = ord, from=1, xlim = c(0,30), use.ggplot = TRUE)
p11<-plot(pt0_PostMi, ord = ord, from=2, xlim = c(0,30), use.ggplot = TRUE)
p12<-plot(pt0_PostMi, ord = ord, from=3, xlim = c(0,30), use.ggplot = TRUE)
...
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_cov_PreMi.1$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$id == id, ]
  }))
...
pb <- txtProgressBar(min = 0, max = B, style = 3)
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_cov_PreMi.2$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$id == id, ]
  }))
...
pb <- txtProgressBar(min = 0, max = B, style = 3)
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_cov_Mi$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_cov_Mi[msdata_0_cov_Mi$id == id, ]
  }))
...
pb <- txtProgressBar(min = 0, max = B, style = 3)
for (i in 1:B) {
  sample_ids <- sample(unique(msdata_0_cov_PostMi$id), replace = TRUE)
  boot_data <- do.call(rbind, lapply(sample_ids, function(id) {
    msdata_0_cov_PostMi[msdata_0_cov_PostMi$id == id, ]
  }))
...
#### Direzione 0: Fascia Oraria & Zona Tratta ----

Preparo i dataset:
```{r}
#Pre-Milano.1 & Fascia Oraria:
msdata_0_PreMi.1_peakm<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$traffico_ora=="Morning-Peak Time", ]
msdata_0_PreMi.1_offpeak<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$traffico_ora=="Off-Peak Time", ]
msdata_0_PreMi.1_peakp<-msdata_0_cov_PreMi.1[msdata_0_cov_PreMi.1$traffico_ora=="Evening-Peak Time", ]

#Pre-Milano.2 & Fascia Oraria:
msdata_0_PreMi.2_peakm<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$traffico_ora=="Morning-Peak Time", ]
msdata_0_PreMi.2_offpeak<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$traffico_ora=="Off-Peak Time", ]
msdata_0_PreMi.2_peakp<-msdata_0_cov_PreMi.2[msdata_0_cov_PreMi.2$traffico_ora=="Evening-Peak Time", ]

#Post-Milano & Fascia Oraria:
msdata_0_PostMi_peakm<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$traffico_ora=="Morning-Peak Time", ]
msdata_0_PostMi_offpeak<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$traffico_ora=="Off-Peak Time", ]
msdata_0_PostMi_peakp<-msdata_0_cov_PostMi[msdata_0_cov_PostMi$traffico_ora=="Evening-Peak Time", ]

#Milano-Città & Fascia Oraria:
msdata_0_Mi_peakm<-msdata_0_cov_Mi[msdata_0_cov_Mi$traffico_ora=="Morning-Peak Time", ]
msdata_0_Mi_offpeak<-msdata_0_cov_Mi[msdata_0_cov_Mi$traffico_ora=="Off-Peak Time", ]
msdata_0_Mi_peakp<-msdata_0_cov_Mi[msdata_0_cov_Mi$traffico_ora=="Evening-Peak Time", ]
```
...
events(msdata_0_PreMi_peakm)
length(unique(msdata_0_PreMi_peakm$ID_Mezzo))
length(unique(msdata_0_PreMi_peakm$ID_Treno))
print("Pre-Milano & OffPeak")
events(msdata_0_PreMi_offpeak)
length(unique(msdata_0_PreMi_offpeak$ID_Mezzo))
length(unique(msdata_0_PreMi_offpeak$ID_Treno))
print("Pre-Milano & EveningPeak")
events(msdata_0_PreMi_peakp)
length(unique(msdata_0_PreMi_peakp$ID_Mezzo))
length(unique(msdata_0_PreMi_peakp$ID_Treno))

#Post-Milano & Fascia Oraria:
print("Post-Milano & MorningPeak")
events(msdata_0_PostMi_peakm)
length(unique(msdata_0_PostMi_peakm$ID_Mezzo))
length(unique(msdata_0_PostMi_peakm$ID_Treno))
print("Post-Milano & OffPeak")
events(msdata_0_PostMi_offpeak)
length(unique(msdata_0_PostMi_offpeak$ID_Mezzo))
length(unique(msdata_0_PostMi_offpeak$ID_Treno))
print("Post-Milano & EveningPeak")
events(msdata_0_PostMi_peakp)
length(unique(msdata_0_PostMi_peakp$ID_Mezzo))
length(unique(msdata_0_PostMi_peakp$ID_Treno))

#Milano-Città & Fascia Oraria:
print("Milano-Città & MorningPeak")
events(msdata_0_Mi_peakm)
length(unique(msdata_0_Mi_peakm$ID_Mezzo))
length(unique(msdata_0_Mi_peakm$ID_Treno))
print("Milano-Città & OffPeak")
events(msdata_0_Mi_offpeak)
length(unique(msdata_0_Mi_offpeak$ID_Mezzo))
length(unique(msdata_0_Mi_offpeak$ID_Treno))
print("Milano-Città & EveningPeak")
events(msdata_0_Mi_peakp)
length(unique(msdata_0_Mi_peakp$ID_Mezzo))
length(unique(msdata_0_Mi_peakp$ID_Treno))
```
...
```{r}
#1.A) metodo aalen:
#Pre-Mialno.1 & Fascia Oraria:
c0_PreMi.1_peakm<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.1_peakm, method = "breslow")
msf0_PreMi.1_peakm <- msfit(object = c0_PreMi.1_peakm, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.1_peakm)
c0_PreMi.1_offpeak<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.1_offpeak, method = "breslow")
msf0_PreMi.1_offpeak <- msfit(object = c0_PreMi.1_offpeak, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.1_offpeak)
c0_PreMi.1_peakp<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.1_peakp, method = "breslow")
msf0_PreMi.1_peakp <- msfit(object = c0_PreMi.1_peakp, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.1_peakp)

#Pre-Mialno.2 & Fascia Oraria:
c0_PreMi.2_peakm<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.2_peakm, method = "breslow")
msf0_PreMi.2_peakm <- msfit(object = c0_PreMi.2_peakm, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.2_peakm)
c0_PreMi.2_offpeak<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.2_offpeak, method = "breslow")
msf0_PreMi.2_offpeak <- msfit(object = c0_PreMi.2_offpeak, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.2_offpeak)
c0_PreMi.2_peakp<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PreMi.2_peakp, method = "breslow")
msf0_PreMi.2_peakp <- msfit(object = c0_PreMi.2_peakp, vartype = "aalen", trans = tmat)
summary(msf0_PreMi.2_peakp)

#Post-Milano & Fascia Oraria: 
c0_PostMi_peakm<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PostMi_peakm, method = "breslow")
msf0_PostMi_peakm <- msfit(object = c0_PostMi_peakm, vartype = "aalen", trans = tmat)
summary(msf0_PostMi_peakm)
c0_PostMi_offpeak<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PostMi_offpeak, method = "breslow")
msf0_PostMi_offpeak <- msfit(object = c0_PostMi_offpeak, vartype = "aalen", trans = tmat)
summary(msf0_PostMi_offpeak)
c0_PostMi_peakp<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_PostMi_peakp, method = "breslow")
msf0_PostMi_peakp <- msfit(object = c0_PostMi_peakp, vartype = "aalen", trans = tmat)
summary(msf0_PostMi_peakp)

#Milano-Città & Fascia Oraria: 
c0_Mi_peakm<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_Mi_peakm, method = "breslow")
msf0_Mi_peakm <- msfit(object = c0_Mi_peakm, vartype = "aalen", trans = tmat)
summary(msf0_Mi_peakm)
c0_Mi_offpeak<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_Mi_offpeak, method = "breslow")
msf0_Mi_offpeak <- msfit(object = c0_Mi_offpeak, vartype = "aalen", trans = tmat)
summary(msf0_Mi_offpeak)
c0_Mi_peakp<-coxph(Surv(time, status) ~ strata(trans), data = msdata_0_Mi_peakp, method = "breslow")
msf0_Mi_peakp <- msfit(object = c0_Mi_peakp, vartype = "aalen", trans = tmat)
summary(msf0_Mi_peakp)
```
...
#PRE-MILANO & FASCIA ORARIA
#Sopravvivenza in orario per tutti e tre i gruppi:
msdata_0_PreMi_peakm_orario <- msdata_0_PreMi_peakm[msdata_0_PreMi_peakm$from == 1, ]
msdata_0_PreMi_offpeak_orario <- msdata_0_PreMi_offpeak[msdata_0_PreMi_offpeak$from == 1, ]
msdata_0_PreMi_peakp_orario <- msdata_0_PreMi_peakp[msdata_0_PreMi_peakp$from == 1, ]

#Sopravvivenza in ritardo per tutti e tre i gruppi:
msdata_0_PreMi_peakm_ritardo_o <- msdata_0_PreMi_peakm[msdata_0_PreMi_peakm$from == 2 & msdata_0_PreMi_peakm$to == 1, ]
msdata_0_PreMi_offpeak_ritardo_o <- msdata_0_PreMi_offpeak[msdata_0_PreMi_offpeak$from == 2 & msdata_0_PreMi_offpeak$to == 1, ]
msdata_0_PreMi_peakp_ritardo_o <- msdata_0_PreMi_peakp[msdata_0_PreMi_peakp$from == 2 & msdata_0_PreMi_peakp$to == 1, ]
msdata_0_PreMi_peakm_ritardo_rg <- msdata_0_PreMi_peakm[msdata_0_PreMi_peakm$from == 2 & msdata_0_PreMi_peakm$to == 3, ]
msdata_0_PreMi_offpeak_ritardo_rg <- msdata_0_PreMi_offpeak[msdata_0_PreMi_offpeak$from == 2 & msdata_0_PreMi_offpeak$to == 3, ]
msdata_0_PreMi_peakp_ritardo_rg <- msdata_0_PreMi_peakp[msdata_0_PreMi_peakp$from == 2 & msdata_0_PreMi_peakp$to == 3, ]

#Sopravvivenza in ritardo grave per tutti e tre i gruppi:
msdata_0_PreMi_peakm_ritgrave <- msdata_0_PreMi_peakm[msdata_0_PreMi_peakm$from == 3, ]
msdata_0_PreMi_offpeak_ritgrave <- msdata_0_PreMi_offpeak[msdata_0_PreMi_offpeak$from == 3, ]
msdata_0_PreMi_peakp_ritgrave <- msdata_0_PreMi_peakp[msdata_0_PreMi_peakp$from == 3, ]


#KAPLAN-MEIER:
#Orario
kaplan_meier_0_orario_PreMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakm_orario)
kaplan_meier_0_orario_PreMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_offpeak_orario)
kaplan_meier_0_orario_PreMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakp_orario)

#Ritardo
kaplan_meier_0_ritardo_PreMi_peakm_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakm_ritardo_o)
kaplan_meier_0_ritardo_PreMi_offpeak_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_offpeak_ritardo_o)
kaplan_meier_0_ritardo_PreMi_peakp_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakp_ritardo_o)
kaplan_meier_0_ritardo_PreMi_peakm_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakm_ritardo_rg)
kaplan_meier_0_ritardo_PreMi_offpeak_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_offpeak_ritardo_rg)
kaplan_meier_0_ritardo_PreMi_peakp_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakp_ritardo_rg)

#Ritardo grave
kaplan_meier_0_ritgrave_PreMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakm_ritgrave)
kaplan_meier_0_ritgrave_PreMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_offpeak_ritgrave)
kaplan_meier_0_ritgrave_PreMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PreMi_peakp_ritgrave)



#POST-MILANO & FASCIA ORARIA
#Sopravvivenza in orario per tutti e tre i gruppi:
msdata_0_PostMi_peakm_orario <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 1, ]
msdata_0_PostMi_offpeak_orario <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 1, ]
msdata_0_PostMi_peakp_orario <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 1, ]

#Sopravvivenza in ritardo per tutti e tre i gruppi:
msdata_0_PostMi_peakm_ritardo_o <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 2 & msdata_0_PostMi_peakm$to == 1, ]
msdata_0_PostMi_offpeak_ritardo_o <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 2 & msdata_0_PostMi_offpeak$to == 1, ]
msdata_0_PostMi_peakp_ritardo_o <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 2 & msdata_0_PostMi_peakp$to == 1, ]
msdata_0_PostMi_peakm_ritardo_rg <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 2 & msdata_0_PostMi_peakm$to == 3, ]
msdata_0_PostMi_offpeak_ritardo_rg <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 2 & msdata_0_PostMi_offpeak$to == 3, ]
msdata_0_PostMi_peakp_ritardo_rg <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 2 & msdata_0_PostMi_peakp$to == 3, ]

#Sopravvivenza in ritardo grave per tutti e tre i gruppi:
msdata_0_PostMi_peakm_ritgrave <- msdata_0_PostMi_peakm[msdata_0_PostMi_peakm$from == 3, ]
msdata_0_PostMi_offpeak_ritgrave <- msdata_0_PostMi_offpeak[msdata_0_PostMi_offpeak$from == 3, ]
msdata_0_PostMi_peakp_ritgrave <- msdata_0_PostMi_peakp[msdata_0_PostMi_peakp$from == 3, ]


#KAPLAN-MEIER:
#Orario
kaplan_meier_0_orario_PostMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_orario)
kaplan_meier_0_orario_PostMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_orario)
kaplan_meier_0_orario_PostMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_orario)

#Ritardo
kaplan_meier_0_ritardo_PostMi_peakm_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_ritardo_o)
kaplan_meier_0_ritardo_PostMi_offpeak_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_ritardo_o)
kaplan_meier_0_ritardo_PostMi_peakp_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_ritardo_o)
kaplan_meier_0_ritardo_PostMi_peakm_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_ritardo_rg)
kaplan_meier_0_ritardo_PostMi_offpeak_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_ritardo_rg)
kaplan_meier_0_ritardo_PostMi_peakp_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_ritardo_rg)

#Ritardo grave
kaplan_meier_0_ritgrave_PostMi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakm_ritgrave)
kaplan_meier_0_ritgrave_PostMi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_offpeak_ritgrave)
kaplan_meier_0_ritgrave_PostMi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_PostMi_peakp_ritgrave)



#MILANO-CITTA' & FASCIA ORARIA
#Sopravvivenza in orario per tutti e tre i gruppi:
msdata_0_Mi_peakm_orario <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 1, ]
msdata_0_Mi_offpeak_orario <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 1, ]
msdata_0_Mi_peakp_orario <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 1, ]

#Sopravvivenza in ritardo per tutti e tre i gruppi:
msdata_0_Mi_peakm_ritardo_o <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 2 & msdata_0_Mi_peakm$to == 1, ]
msdata_0_Mi_offpeak_ritardo_o <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 2 & msdata_0_Mi_offpeak$to == 1, ]
msdata_0_Mi_peakp_ritardo_o <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 2 & msdata_0_Mi_peakp$to == 1, ]
msdata_0_Mi_peakm_ritardo_rg <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 2 & msdata_0_Mi_peakm$to == 3, ]
msdata_0_Mi_offpeak_ritardo_rg <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 2 & msdata_0_Mi_offpeak$to == 3, ]
msdata_0_Mi_peakp_ritardo_rg <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 2 & msdata_0_Mi_peakp$to == 3, ]

#Sopravvivenza in ritardo grave per tutti e tre i gruppi:
msdata_0_Mi_peakm_ritgrave <- msdata_0_Mi_peakm[msdata_0_Mi_peakm$from == 3, ]
msdata_0_Mi_offpeak_ritgrave <- msdata_0_Mi_offpeak[msdata_0_Mi_offpeak$from == 3, ]
msdata_0_Mi_peakp_ritgrave <- msdata_0_Mi_peakp[msdata_0_Mi_peakp$from == 3, ]


#KAPLAN-MEIER:
#Orario
kaplan_meier_0_orario_Mi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_orario)
kaplan_meier_0_orario_Mi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_orario)
kaplan_meier_0_orario_Mi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_orario)

#Ritardo
kaplan_meier_0_ritardo_Mi_peakm_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_ritardo_o)
kaplan_meier_0_ritardo_Mi_offpeak_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_ritardo_o)
kaplan_meier_0_ritardo_Mi_peakp_o <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_ritardo_o)
kaplan_meier_0_ritardo_Mi_peakm_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_ritardo_rg)
kaplan_meier_0_ritardo_Mi_offpeak_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_ritardo_rg)
kaplan_meier_0_ritardo_Mi_peakp_rg <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_ritardo_rg)

#Ritardo grave
kaplan_meier_0_ritgrave_Mi_peakm <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakm_ritgrave)
kaplan_meier_0_ritgrave_Mi_offpeak <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_offpeak_ritgrave)
kaplan_meier_0_ritgrave_Mi_peakp <- survfit(Surv(time, status) ~ 1, data = msdata_0_Mi_peakp_ritgrave)
```


1) PreMilano & Fascia oraria
```{r}
# Imposta la griglia di plot
par(mfrow=c(1,2))

# SOPRAVVIVENZA IN ORARIO:
plot(kaplan_meier_0_orario_PreMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,20))
lines(kaplan_meier_0_orario_PreMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_orario_PreMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)


# SOPRAVVIVENZA IN RITARDO GRAVE:
plot(kaplan_meier_0_ritgrave_PreMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2, xlim = c(0, 10), conf.int=FALSE)
lines(kaplan_meier_0_ritgrave_PreMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ritgrave_PreMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```
...
# SOPRAVVIVENZA IN ORARIO:
plot(kaplan_meier_0_orario_PostMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,15))
lines(kaplan_meier_0_orario_PostMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_orario_PostMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)


# SOPRAVVIVENZA IN RITARDO GRAVE:
plot(kaplan_meier_0_ritgrave_PostMi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0,15))
lines(kaplan_meier_0_ritgrave_PostMi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ritgrave_PostMi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```
...
# SOPRAVVIVENZA IN ORARIO:
plot(kaplan_meier_0_orario_Mi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From OnTime to Delay", col="#87CEFA", lwd = 2, conf.int=FALSE, xlim = c(0, 20))
lines(kaplan_meier_0_orario_Mi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_orario_Mi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
legend("bottomleft", legend = c("Morning Peak", "Off Peak", "Evening Peak"), 
       col = c("#87CEFA", "#EB5C82", "#F59B51"), bty = "n", lwd = 2, cex = 1.2)


# SOPRAVVIVENZA IN RITARDO GRAVE:
plot(kaplan_meier_0_ritgrave_Mi_peakm, xlab = "Time (min)", ylab = "Survival in the current state", 
     main = "From SevereDelay to Delay", col="#87CEFA", lwd = 2,, xlim = c(0, 20), conf.int=FALSE)
lines(kaplan_meier_0_ritgrave_Mi_offpeak, col = "#EB5C82", lwd = 2, conf.int=FALSE)
lines(kaplan_meier_0_ritgrave_Mi_peakp, col = "#F59B51", lwd = 2, conf.int=FALSE)
```


PROBABILITA' DI TRANSIZIONE:
1) Pre-Milano.1 & Fascia Oraria
```{r}
#Probabilità di transizione di lì a :
pt0_PreMi.1_peakm <- probtrans(msf0_PreMi.1_peakm, predt = 0, method = "aalen")

pt0_PreMi.1_offpeak <- probtrans(msf0_PreMi.1_offpeak, predt = 0, method = "aalen")

pt0_PreMi.1_peakp <- probtrans(msf0_PreMi.1_peakp, predt = 0, method = "aalen")


statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
#plot Pre-Milano & Peak Mattina: 
p1<-plot(pt0_PreMi.1_peakm, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p1 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p2<-plot(pt0_PreMi.1_peakm, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p2 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot Peak: starting state= Ritardo nel lungo tempo
p3<-plot(pt0_PreMi.1_peakm, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p3 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
p4<-plot(pt0_PreMi.1_offpeak, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p4 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p5<-plot(pt0_PreMi.1_offpeak, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p5 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p6<-plot(pt0_PreMi.1_offpeak, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p6 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
p7<-plot(pt0_PreMi.1_peakp, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p7 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p8<-plot(pt0_PreMi.1_peakp, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p8 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p9<-plot(pt0_PreMi.1_peakp, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p9 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
2) Pre-Milano.2 & Fascia Oraria
```{r}
#Probabilità di transizione di lì a :
pt0_PreMi.2_peakm <- probtrans(msf0_PreMi.2_peakm, predt = 0, method = "aalen")

pt0_PreMi.2_offpeak <- probtrans(msf0_PreMi.2_offpeak, predt = 0, method = "aalen")

pt0_PreMi.2_peakp <- probtrans(msf0_PreMi.2_peakp, predt = 0, method = "aalen")


statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
#plot Pre-Milano & Peak Mattina: 
p1<-plot(pt0_PreMi.2_peakm, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p1 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p2<-plot(pt0_PreMi.2_peakm, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p2 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot Peak: starting state= Ritardo nel lungo tempo
p3<-plot(pt0_PreMi.2_peakm, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p3 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Off Peak:
p4<-plot(pt0_PreMi.2_offpeak, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p4 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p5<-plot(pt0_PreMi.2_offpeak, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p5 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p6<-plot(pt0_PreMi.2_offpeak, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p6 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Peak Pome:
p7<-plot(pt0_PreMi.2_peakp, ord = ord, from=1, xlim= c(0,20), use.ggplot = TRUE)
p7 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p8<-plot(pt0_PreMi.2_peakp, ord = ord, from=2, xlim= c(0,20), use.ggplot = TRUE)
p8 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p9<-plot(pt0_PreMi.2_peakp, ord = ord, from=3, xlim= c(0,20), use.ggplot = TRUE)
p9 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
```{r}
#Probabilità di transizione di lì a :
pt0_PostMi_peakm <- probtrans(msf0_PostMi_peakm, predt = 0, method = "aalen")

pt0_PostMi_offpeak <- probtrans(msf0_PostMi_offpeak, predt = 0, method = "aalen")

pt0_PostMi_peakp <- probtrans(msf0_PostMi_peakp, predt = 0, method = "aalen")


statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
#plot Pre-Milano & Peak Mattina: 
p1<-plot(pt0_PostMi_peakm, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p1 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p2<-plot(pt0_PostMi_peakm, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p2 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot Peak: starting state= Ritardo nel lungo tempo
p3<-plot(pt0_PostMi_peakm, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p3 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Off Peak:
p4<-plot(pt0_PostMi_offpeak, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p4 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p5<-plot(pt0_PostMi_offpeak, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p5 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p6<-plot(pt0_PostMi_offpeak, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p6 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Peak Pome:
p7<-plot(pt0_PostMi_peakp, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p7 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p8<-plot(pt0_PostMi_peakp, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p8 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p9<-plot(pt0_PostMi_peakp, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p9 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
4) Milano-Città & Fascia Oraria
```{r}
#Probabilità di transizione di lì a :
pt0_Mi_peakm <- probtrans(msf0_Mi_peakm, predt = 0, method = "aalen")

pt0_Mi_offpeak <- probtrans(msf0_Mi_offpeak, predt = 0, method = "aalen")

pt0_Mi_peakp <- probtrans(msf0_Mi_peakp, predt = 0, method = "aalen")


statecols <- c("#C3EEBF", "#FBDD88", "#E05265")
ord <- c(1,2,3)
#plot Pre-Milano & Peak Mattina: 
p1<-plot(pt0_Mi_peakm, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p1 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p2<-plot(pt0_Mi_peakm, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p2 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot Peak: starting state= Ritardo nel lungo tempo
p3<-plot(pt0_Mi_peakm, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p3 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Off Peak:
p4<-plot(pt0_Mi_offpeak, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p4 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p5<-plot(pt0_Mi_offpeak, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p5 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p6<-plot(pt0_Mi_offpeak, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p6 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
...
#plot Pre-Milano & Peak Pome:
p7<-plot(pt0_Mi_peakp, ord = ord, from=1, use.ggplot = TRUE, xlim = c(0,20))
p7 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from OnTime)",x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot1: starting state= Ritardo nel lungo tempo
p8<-plot(pt0_Mi_peakp, ord = ord, from=2, use.ggplot = TRUE, xlim = c(0,20))
p8 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from Delay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
  guides(fill = guide_legend(title = "States"))  # Modifica il titolo della legenda
#plot0: starting state= Ritardo nel lungo tempo
p9<-plot(pt0_Mi_peakp, ord = ord, from=3, use.ggplot = TRUE, xlim = c(0,20))
p9 + 
  scale_fill_manual(values = statecols) +
  theme_minimal() + 
  labs(title = "Transition Probabilities (starting from SevereDelay)", x = "Time (Minutes)", y = "Probability") +  # Aggiungi etichette
